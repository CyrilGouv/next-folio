...
const TextHero = ({ text, layout = "default", image = false, video = false, localisation = null }) => {
    ...
    useGSAP(() => {
        ...
        if(layout === "homepage" || layout === "services") {
        ...
        return (
            <div ref={ sectionEl } className={ styles.text }>
                ...
                >
                    ...
                    <span className={ styles.text__location__inner }>{ localisation }, FR</span>
                </p>
                <p 
                    ref={ textEl } 
